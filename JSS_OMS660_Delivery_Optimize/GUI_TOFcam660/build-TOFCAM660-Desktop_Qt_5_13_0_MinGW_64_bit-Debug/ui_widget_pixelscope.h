...
public:
    ...
    void setupUi(QWidget *WidgetPixelScope)
    {
        ...
        WidgetPixelScope->resize(702, 204);
        ...
        rbDCS0 = new QRadioButton(WidgetPixelScope);
        rbDCS0->setObjectName(QString::fromUtf8("rbDCS0"));

        horizontalLayout_3->addWidget(rbDCS0);

        rbDCS1 = new QRadioButton(WidgetPixelScope);
        rbDCS1->setObjectName(QString::fromUtf8("rbDCS1"));

        horizontalLayout_3->addWidget(rbDCS1);

        rbDCS2 = new QRadioButton(WidgetPixelScope);
        rbDCS2->setObjectName(QString::fromUtf8("rbDCS2"));

        horizontalLayout_3->addWidget(rbDCS2);

        rbDCS3 = new QRadioButton(WidgetPixelScope);
        rbDCS3->setObjectName(QString::fromUtf8("rbDCS3"));

        horizontalLayout_3->addWidget(rbDCS3);


        gridLayout_2->addLayout(horizontalLayout_3, 4, 0, 1, 8);
    ...
    void retranslateUi(QWidget *WidgetPixelScope)
    {
        ...
        rbDCS0->setText(QCoreApplication::translate("WidgetPixelScope", "DCS0", nullptr));
        rbDCS1->setText(QCoreApplication::translate("WidgetPixelScope", "DCS1", nullptr));
        rbDCS2->setText(QCoreApplication::translate("WidgetPixelScope", "DCS2", nullptr));
        rbDCS3->setText(QCoreApplication::translate("WidgetPixelScope", "DCS3", nullptr));
