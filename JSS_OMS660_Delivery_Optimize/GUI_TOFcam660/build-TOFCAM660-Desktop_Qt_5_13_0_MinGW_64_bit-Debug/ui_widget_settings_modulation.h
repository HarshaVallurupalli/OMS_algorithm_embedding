...
public:
    ...
    void setupUi(QWidget *WidgetSettingsModulation)
    {
        ...
        WidgetSettingsModulation->resize(366, 162);
...
""));
        ...
        sizePolicy1.setHeightForWidth(cbModeFrequency->sizePolicy().hasHeightForWidth());
        cbModeFrequency->setSizePolicy(sizePolicy1);
        cbModeFrequency->setMinimumSize(QSize(100, 0));
        cbModeFrequency->setMaximumSize(QSize(16777215, 16777215));
        cbModeFrequency->setSizeIncrement(QSize(0, 1));
        QFont font2;
        ...
        cbModeFrequency->setFont(font2);
        cbModeFrequency->setAcceptDrops(false);
        cbModeFrequency->setLayoutDirection(Qt::LeftToRight);
        ...
        cbModeFrequency->setMinimumContentsLength(8);
        cbModeFrequency->setIconSize(QSize(16, 16));
        ...
        cmbChannel->setFont(font3);
        cmbChannel->setLayoutDirection(Qt::LeftToRight);
        ...
        cbModeFrequency->setCurrentIndex(0);
    ...
    void retranslateUi(QWidget *WidgetSettingsModulation)
    {
        ...
        cbModeFrequency->setCurrentText(QCoreApplication::translate("WidgetSettingsModulation", "   24 Mhz", nullptr));
