...
class WidgetData : public QWidget
{
  ...
  public:
    ...
    void showDCS(const char *pData, DataHeader &dataHeader);
...
signals:
    ...
    void updateTimeScopeDCS(const char *pData, DataHeader &dataHeader);
...
private:
    ...
    ImageColorizer imageColorizerDCS0;
    ImageColorizer imageColorizerDCS1;
    ImageColorizer imageColorizerDCS2;
    ImageColorizer imageColorizerDCS3;
