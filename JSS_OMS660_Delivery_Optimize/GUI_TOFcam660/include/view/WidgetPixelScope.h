...
class WidgetPixelScope : public QWidget
{
  ...
  private slots:    
    ...
    void on_rbDCS0_toggled(bool checked);
    void on_rbDCS1_toggled(bool checked);
    void on_rbDCS2_toggled(bool checked);
    void on_rbDCS3_toggled(bool checked);

public slots:
    void onDataReceived(const char *pData, DataHeader &dataHeader, bool amplitude);
    void onDCSDataReceived(const char *pData, DataHeader &dataHeader);
