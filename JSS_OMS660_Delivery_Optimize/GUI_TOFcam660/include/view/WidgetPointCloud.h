...
public slots:
    ...
    void autoRotatingToggled(bool checked);
    void grayPointCloudChanged(bool checked);    
...
private slots:
    ...
    void formatChanged();
    void mirrorChanged();    
    void on_cbRotate_toggled(bool checked);
    void on_cbShift_toggled(bool checked);
    void on_tbView_clicked();
    void on_cbRotate90_toggled(bool checked);
    void on_cbZoom_toggled(bool checked);
