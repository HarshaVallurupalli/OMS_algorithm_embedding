...
class WidgetInfo : public QWidget
{
  ...
  private:    
    ...
    void getDCSPixelValue(const char *pData, DataHeader &dataHeader, unsigned int index, uint &dcs0, uint &dcs1, uint &dcs2, uint &dcs3);
    ...
    void setDcs(const unsigned int dcs0, const unsigned int dcs1, const unsigned int dcs2, const unsigned int dcs3);
    void clearDataLeft();
    void clearDataRight();
