...
{  
    ...
    userplotstyle_p = nullptr;
    shading_ = GOURAUD;
    floorstyle_ = NOFLOOR;
    isolines_ = 10;
    displaylegend_ = false;
    smoothdatamesh_p = false;
    actualData_p = nullptr;
    ...
    assignMouse(MouseState(Qt::LeftButton, Qt::ControlModifier | Qt::ShiftModifier), MouseState(Qt::LeftButton, Qt::ControlModifier | Qt::ShiftModifier), MouseState(Qt::LeftButton, Qt::ShiftModifier), MouseState(Qt::LeftButton, Qt::AltModifier),
                MouseState(Qt::LeftButton, Qt::AltModifier),MouseState(Qt::LeftButton, Qt::AltModifier | Qt::ShiftModifier),
                MouseState(Qt::LeftButton, Qt::AltModifier | Qt::ControlModifier), MouseState(Qt::LeftButton, Qt::ControlModifier), MouseState(Qt::LeftButton, Qt::ControlModifier));

    assignKeyboard(Qt::Key_Down, Qt::Key_Up,    Qt::Key_Left, Qt::Key_Right, KeyboardState(Qt::Key_Right, Qt::ShiftModifier), KeyboardState(Qt::Key_Left, Qt::ShiftModifier),
    ...
    zoomState_     = false; //lsi
    rotationState_ = false; //lsi
    shiftState_ = false;    //lsi
    totalScaleFactor = 1.0; //lsi
}
