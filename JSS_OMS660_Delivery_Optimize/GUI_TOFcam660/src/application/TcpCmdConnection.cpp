...
int TcpCmdConnection::output(QTcpSocket &socket, QByteArray &dataToSend)
{
  ...
  dataToSend.insert(0, static_cast<char>((MARKING_START >> 24) & 0xFF));
  dataToSend.insert(1, static_cast<char>((MARKING_START >> 16) & 0xFF));
  dataToSend.insert(2, static_cast<char>((MARKING_START >> 8) & 0xFF));
  dataToSend.insert(3, static_cast<char>((MARKING_START >> 0) & 0xFF));

  dataToSend.insert(4, static_cast<char>((payloadSize >> 24) & 0xFF));
  dataToSend.insert(5, static_cast<char>((payloadSize >> 16) & 0xFF));
  dataToSend.insert(6, static_cast<char>((payloadSize >> 8) & 0xFF));
  dataToSend.insert(7, static_cast<char>((payloadSize >> 0) & 0xFF));

  dataToSend.append(static_cast<char>((MARKING_END >> 24) & 0xFF));
  dataToSend.append(static_cast<char>((MARKING_END >> 16) & 0xFF));
  dataToSend.append(static_cast<char>((MARKING_END >> 8) & 0xFF));
  dataToSend.append(static_cast<char>((MARKING_END >> 0) & 0xFF));
