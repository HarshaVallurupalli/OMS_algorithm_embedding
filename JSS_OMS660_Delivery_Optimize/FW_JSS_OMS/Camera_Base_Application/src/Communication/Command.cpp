...
//Algorithm Edit
uint16_t Command::getMovementDetectionWindowSize() const
{
  return Util::getValueUint16BigEndian(data, CommunicationConstants::CommandData::Algorithms::INDEX_MOVEMENT_DETECTION_WINDOW_SIZE);
}
/**
