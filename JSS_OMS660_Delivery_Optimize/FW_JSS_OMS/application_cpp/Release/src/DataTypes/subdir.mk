...
CPP_SRCS += \
../src/DataTypes/CmdProcessorAnswer.cpp \
../src/DataTypes/CmdProcessorJob.cpp 

OBJS += \
./src/DataTypes/CmdProcessorAnswer.o \
./src/DataTypes/CmdProcessorJob.o 

CPP_DEPS += \
./src/DataTypes/CmdProcessorAnswer.d \
./src/DataTypes/CmdProcessorJob.d 


# Each subdirectory must supply rules for building sources it contributes
src/DataTypes/%.o: ../src/DataTypes/%.cpp
	@echo 'Building file: $<'
