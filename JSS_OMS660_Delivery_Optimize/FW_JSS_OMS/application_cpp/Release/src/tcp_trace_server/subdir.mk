...
C_SRCS += \
../src/tcp_trace_server/tcp_trace_server.c 

OBJS += \
./src/tcp_trace_server/tcp_trace_server.o 

C_DEPS += \
./src/tcp_trace_server/tcp_trace_server.d 


# Each subdirectory must supply rules for building sources it contributes
src/tcp_trace_server/%.o: ../src/tcp_trace_server/%.c
	@echo 'Building file: $<'
