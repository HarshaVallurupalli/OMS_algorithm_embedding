...
{        
    ...
    ui->comboBoxStreamConnectionType->setCurrentIndex(context.getSettings().getCameraNumber());//edit
...
void WidgetImage::changeImageType()//redundant code
{
...
void WidgetImage::on_comboBoxImageType_currentIndexChanged(int index)
{
    ...
    changeImageType();//redundant code
