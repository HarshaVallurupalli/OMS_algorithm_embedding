...
void Function::setMin(double x, double y, double z){
    plotwidget_p->setMinX(x);
    plotwidget_p->setMinY(y);
    setMinZ(z);
}

void Function::setMax(double x, double y, double z){
    plotwidget_p->setMaxX(x);
    plotwidget_p->setMaxY(y);
    setMaxZ(z);
}
