...
#
# Generated by export_simulation on Tue Jul 07 08:23:45 -0400 2020
#
################################################################################
...
'-reset_run' switch to the './div_gen_dist_offset.sh' script.

./div_gen_dist_offset.sh -reset_run
...
./div_gen_dist_offset.sh -noclean_files

For more information on the script, please type './div_gen_dist_offset.sh -help'.
