...
architecture Behavioral of ip_image_bin is
...
begin
	...
	process(reg_data_in_D, data_in_DI, bad_pixel_DI, reg_pix_inter_en_SI, reg_adc_en_SI, line_cnt_D, reg_remove_sat_en_SI, reg_line_length_DI, en_DI, second_half)
	begin
    ...
    -- data out bad pix
    process(data_13_D, data_03_D, data_2_D, data_3_D, data_0_D, data_1_D, line_cnt_D, bad_pixel_reg_D, reg_adc_en_SI, reg_remove_sat_en_SI, reg_line_length_DI, second_half)
    begin
