...
HD_PWD='C:/JSS_OMS660_Delivery200227/SL_JSS_OMS/IP/epc660/epc660.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log jss_oms_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source jss_oms_top.tcl -notrace
