...
HD_PWD='C:/JSS_OMS660_Delivery200227/SL_JSS_OMS/IP/epc660/epc660.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log jss_oms_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source jss_oms_top.tcl
