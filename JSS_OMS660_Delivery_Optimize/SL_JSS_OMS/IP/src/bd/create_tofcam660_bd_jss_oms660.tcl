...
proc create_root_design { parentCell } {
  ...
  set axi_bram_ctrl_dbg_unit [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_bram_ctrl axi_bram_ctrl_dbg_unit ]
  set_property -dict [ list \
  ...
  set axi_mem_intercon_3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect axi_mem_intercon_3 ]
  set_property -dict [ list \
   CONFIG.NUM_MI {1} \
   CONFIG.NUM_SI {2} \
 ] $axi_mem_intercon_3
  ...
  set blk_mem_gen_dbg_unit [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen blk_mem_gen_dbg_unit ]
  set_property -dict [ list \
  ...
  set data2ram_dcs [ create_bd_cell -type ip -vlnv xilinx.com:user:data2ram data2ram_dcs ]
  set_property -dict [ list \
  ...
  set data2ram_gs [ create_bd_cell -type ip -vlnv xilinx.com:user:data2ram data2ram_gs ]
  set_property -dict [ list \
   CONFIG.C_M00_AXI_BURST_LEN {16} \
   CONFIG.NBITS_BRAM_ADDR {11} \
  ...
  connect_bd_net -net axi_peri_resetn [get_bd_pins TOF_cos_sl_0/reset_RBI] [get_bd_pins axi_bram_ctrl_dbg_unit/s_axi_aresetn] [get_bd_pins axi_gpio_led/s_axi_aresetn] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon_1/M00_ARESETN] [get_bd_pins axi_mem_intercon_1/S00_ARESETN] [get_bd_pins axi_mem_intercon_3/M00_ARESETN] [get_bd_pins axi_mem_intercon_3/S00_ARESETN] [get_bd_pins axi_mem_intercon_3/S01_ARESETN] [get_bd_pins axi_smc/aresetn] [get_bd_pins clk_wiz_0/s_axi_aresetn] [get_bd_pins gpio_shutter/s_axi_aresetn] [get_bd_pins ps7_1_axi_periph/M00_ARESETN] [get_bd_pins ps7_1_axi_periph/M01_ARESETN] [get_bd_pins ps7_1_axi_periph/M02_ARESETN] [get_bd_pins ps7_1_axi_periph/M03_ARESETN] [get_bd_pins ps7_1_axi_periph/M04_ARESETN] [get_bd_pins ps7_1_axi_periph/M05_ARESETN] [get_bd_pins ps7_1_axi_periph/M06_ARESETN] [get_bd_pins readRam_burst_1/m00_axi_aresetn] [get_bd_pins reg_bank_0/s00_axi_aresetn] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
