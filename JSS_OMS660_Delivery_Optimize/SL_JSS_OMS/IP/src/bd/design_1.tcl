...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
xilinx.com:espros:TOF_cos_sl:*\
xilinx.com:ip:axi_dma:*\
xilinx.com:ip:axi_gpio:*\
xilinx.com:ip:smartconnect:*\
xilinx.com:user:axis_switch_2to1:*\
xilinx.com:ip:blk_mem_gen:*\
xilinx.com:ip:clk_wiz:*\
msc:msc:data2axistream_v1_0:*\
xilinx.com:user:data2ram_v1_0:*\
xilinx.com:ip:processing_system7:*\
xilinx.com:user:readRam_burst:*\
xilinx.com:user:reg_bank:*\
msc:msc:rename_net:*\
...
proc create_root_design { parentCell } {
  ...
  set TOF_cos_sl_0 [ create_bd_cell -type ip -vlnv xilinx.com:espros:TOF_cos_sl TOF_cos_sl_0 ]
  set_property -dict [ list \
   CONFIG.ENABLE_INPUT_FIFO {true} \
 ] $TOF_cos_sl_0

  # Create instance: axi_dma_SG_sort, and set properties
  set axi_dma_SG_sort [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_dma axi_dma_SG_sort ]
  set_property -dict [ list \
  ...
  set axi_gpio_power_reset [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio axi_gpio_power_reset ]
  set_property -dict [ list \
   CONFIG.C_ALL_OUTPUTS {1} \
  ...
  set axis_switch_2to1_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:axis_switch_2to1 axis_switch_2to1_0 ]

  # Create instance: blk_mem_gen_dcs, and set properties
  set blk_mem_gen_dcs [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen blk_mem_gen_dcs ]
  set_property -dict [ list \
  ...
  set blk_mem_gen_gs [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen blk_mem_gen_gs ]
  set_property -dict [ list \
   CONFIG.Assume_Synchronous_Clk {true} \
   CONFIG.Byte_Size {9} \
   CONFIG.EN_SAFETY_CKT {false} \
  ...
  set data2axistream_v1_0_3 [ create_bd_cell -type ip -vlnv msc:msc:data2axistream_v1_0 data2axistream_v1_0_3 ]
  set_property -dict [ list \
  ...
  set data2axistream_v1_0_4 [ create_bd_cell -type ip -vlnv msc:msc:data2axistream_v1_0 data2axistream_v1_0_4 ]
  set_property -dict [ list \
   CONFIG.INPUT_BUS_WIDTH {13} \
 ] $data2axistream_v1_0_4

  # Create instance: data2ram_dcs, and set properties
  set data2ram_dcs [ create_bd_cell -type ip -vlnv xilinx.com:user:data2ram_v1_0 data2ram_dcs ]
  set_property -dict [ list \
  ...
  set data2ram_gs [ create_bd_cell -type ip -vlnv xilinx.com:user:data2ram_v1_0 data2ram_gs ]
  set_property -dict [ list \
   CONFIG.C_M00_AXI_BURST_LEN {16} \
   CONFIG.NBITS_BRAM_ADDR {11} \
  ...
  set gpio_shutter [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio gpio_shutter ]
  set_property -dict [ list \
   CONFIG.C_ALL_INPUTS_2 {0} \
   CONFIG.C_ALL_OUTPUTS {1} \
  ...
  set ps7_1_axi_periph [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect ps7_1_axi_periph ]
  set_property -dict [ list \
   CONFIG.NUM_MI {6} \
 ] $ps7_1_axi_periph

  # Create instance: readRam_burst_1, and set properties
  set readRam_burst_1 [ create_bd_cell -type ip -vlnv xilinx.com:user:readRam_burst readRam_burst_1 ]
  set_property -dict [ list \
  ...
  set reg_bank_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:reg_bank reg_bank_0 ]

  # Create instance: rename_net_0, and set properties
  set rename_net_0 [ create_bd_cell -type ip -vlnv msc:msc:rename_net rename_net_0 ]

  # Create instance: rename_net_2, and set properties
  set rename_net_2 [ create_bd_cell -type ip -vlnv msc:msc:rename_net rename_net_2 ]
  ...
  set sg_dma_intr_isolation [ create_bd_cell -type ip -vlnv msc:msc:rename_net sg_dma_intr_isolation ]
  set_property -dict [ list \
   CONFIG.INBITS {1} \
   CONFIG.OUTBITS {1} \
  ...
  connect_bd_intf_net -intf_net axi_dma_SG_sort_M_AXI_S2MM [get_bd_intf_pins axi_dma_SG_sort/M_AXI_S2MM] [get_bd_intf_pins axi_mem_intercon_2/S00_AXI]
  connect_bd_intf_net -intf_net axi_dma_SG_sort_M_AXI_SG [get_bd_intf_pins axi_dma_SG_sort/M_AXI_SG] [get_bd_intf_pins axi_mem_intercon_2/S01_AXI]
  ...
  connect_bd_intf_net -intf_net axi_mem_intercon_2_M00_AXI [get_bd_intf_pins axi_mem_intercon_2/M00_AXI] [get_bd_intf_pins processing_system7_1/S_AXI_HP3]
  ...
  connect_bd_net -net TOF_cos_sl_0_cc_img_bin_dcs_sel_DO [get_bd_pins TOF_cos_sl_0/cc_img_bin_dcs_sel_DO] [get_bd_pins rename_net_2/data_in]
  ...
  connect_bd_net -net TOF_cos_sl_0_dist_amp_sat_concat_DO [get_bd_pins TOF_cos_sl_0/dist_amp_sat_concat_DO] [get_bd_pins data2axistream_v1_0_3/input_data]
  ...
  connect_bd_net -net TOF_cos_sl_0_en_d2r_dcs_SO [get_bd_pins TOF_cos_sl_0/en_d2r_dcs_SO] [get_bd_pins data2axistream_v1_0_3/en] [get_bd_pins data2axistream_v1_0_3/resetn] [get_bd_pins data2axistream_v1_0_4/en] [get_bd_pins data2axistream_v1_0_4/resetn] [get_bd_pins data2ram_dcs/enable_DI]
  ...
  connect_bd_net -net TOF_cos_sl_0_tcmi_pixel_cnt_DO [get_bd_pins TOF_cos_sl_0/tcmi_pixel_cnt_DO] [get_bd_pins rename_net_0/data_in]
  ...
  connect_bd_net -net axi_gpio_power_reset_gpio_io_o [get_bd_ports gpio_io_o_0] [get_bd_pins axi_gpio_power_reset/gpio_io_o]
  connect_bd_net -net axi_peri_resetn [get_bd_pins TOF_cos_sl_0/reset_RBI] [get_bd_pins axi_gpio_led/s_axi_aresetn] [get_bd_pins axi_gpio_power_reset/s_axi_aresetn] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon_1/M00_ARESETN] [get_bd_pins axi_mem_intercon_1/S00_ARESETN] [get_bd_pins axi_mem_intercon_2/M00_ARESETN] [get_bd_pins axi_mem_intercon_2/S00_ARESETN] [get_bd_pins axi_mem_intercon_2/S01_ARESETN] [get_bd_pins axi_smc/aresetn] [get_bd_pins clk_wiz_0/s_axi_aresetn] [get_bd_pins gpio_shutter/s_axi_aresetn] [get_bd_pins ps7_1_axi_periph/M00_ARESETN] [get_bd_pins ps7_1_axi_periph/M01_ARESETN] [get_bd_pins ps7_1_axi_periph/M02_ARESETN] [get_bd_pins ps7_1_axi_periph/M03_ARESETN] [get_bd_pins ps7_1_axi_periph/M04_ARESETN] [get_bd_pins ps7_1_axi_periph/M05_ARESETN] [get_bd_pins readRam_burst_1/m00_axi_aresetn] [get_bd_pins reg_bank_0/s00_axi_aresetn] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  ...
  connect_bd_net -net camera_ctrl_v1_0_0_alu_amp_corr [get_bd_pins TOF_cos_sl_0/rbk_alu_amp_corr_DI] [get_bd_pins reg_bank_0/alu_amp_corr_DO]
  connect_bd_net -net camera_ctrl_v1_0_0_alu_dist_corr [get_bd_pins TOF_cos_sl_0/rbk_alu_dist_corr_DI] [get_bd_pins reg_bank_0/alu_dist_corr_DO]
  connect_bd_net -net camera_ctrl_v1_0_0_alu_min_index [get_bd_pins TOF_cos_sl_0/rbk_alu_minIndex_DI] [get_bd_pins reg_bank_0/alu_min_index_DO]
  ...
  connect_bd_net -net data_in_1 [get_bd_ports data_in] [get_bd_pins TOF_cos_sl_0/data_in_DI]
  connect_bd_net -net dclk_in_1 [get_bd_ports dclk_in] [get_bd_pins TOF_cos_sl_0/dclk_in_SI]
  ...
  connect_bd_net -net hsync_in_1 [get_bd_ports hsync_in] [get_bd_pins TOF_cos_sl_0/hsync_in_SI]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins TOF_cos_sl_0/clk_CI] [get_bd_pins axi_dma_SG_sort/m_axi_s2mm_aclk] [get_bd_pins axi_dma_SG_sort/m_axi_sg_aclk] [get_bd_pins axi_dma_SG_sort/s_axi_lite_aclk] [get_bd_pins axi_gpio_led/s_axi_aclk] [get_bd_pins axi_gpio_power_reset/s_axi_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon_1/ACLK] [get_bd_pins axi_mem_intercon_1/M00_ACLK] [get_bd_pins axi_mem_intercon_1/S00_ACLK] [get_bd_pins axi_mem_intercon_2/ACLK] [get_bd_pins axi_mem_intercon_2/M00_ACLK] [get_bd_pins axi_mem_intercon_2/S00_ACLK] [get_bd_pins axi_mem_intercon_2/S01_ACLK] [get_bd_pins axi_smc/aclk] [get_bd_pins blk_mem_gen_dcs/clka] [get_bd_pins blk_mem_gen_dcs/clkb] [get_bd_pins blk_mem_gen_gs/clka] [get_bd_pins blk_mem_gen_gs/clkb] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins clk_wiz_0/s_axi_aclk] [get_bd_pins data2axistream_v1_0_3/clk] [get_bd_pins data2axistream_v1_0_3/m00_axis_aclk] [get_bd_pins data2axistream_v1_0_4/clk] [get_bd_pins data2axistream_v1_0_4/m00_axis_aclk] [get_bd_pins data2ram_dcs/clk_CI] [get_bd_pins data2ram_dcs/m00_axi_aclk] [get_bd_pins data2ram_gs/clk_CI] [get_bd_pins data2ram_gs/m00_axi_aclk] [get_bd_pins gpio_shutter/s_axi_aclk] [get_bd_pins processing_system7_1/FCLK_CLK0] [get_bd_pins processing_system7_1/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_1/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_1/S_AXI_HP1_ACLK] [get_bd_pins processing_system7_1/S_AXI_HP2_ACLK] [get_bd_pins processing_system7_1/S_AXI_HP3_ACLK] [get_bd_pins ps7_1_axi_periph/ACLK] [get_bd_pins ps7_1_axi_periph/M00_ACLK] [get_bd_pins ps7_1_axi_periph/M01_ACLK] [get_bd_pins ps7_1_axi_periph/M02_ACLK] [get_bd_pins ps7_1_axi_periph/M03_ACLK] [get_bd_pins ps7_1_axi_periph/M04_ACLK] [get_bd_pins ps7_1_axi_periph/M05_ACLK] [get_bd_pins ps7_1_axi_periph/S00_ACLK] [get_bd_pins readRam_burst_1/clk_CI] [get_bd_pins readRam_burst_1/m00_axi_aclk] [get_bd_pins reg_bank_0/s00_axi_aclk] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_1_FCLK_RESET0_N [get_bd_pins processing_system7_1/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net readRam_burst_0_read_pulse_out_DO [get_bd_pins TOF_cos_sl_0/readRam_pulse_out_SI] [get_bd_pins readRam_burst_1/read_pulse_out_DO]
  ...
  connect_bd_net -net reg_stage_grey_out_data_DO [get_bd_pins TOF_cos_sl_0/grey_pulse_out_SO] [get_bd_pins data2axistream_v1_0_4/pulse] [get_bd_pins data2ram_gs/pulse_in_DI]
  connect_bd_net -net resed_or_done_edge_RB [get_bd_pins TOF_cos_sl_0/reset_or_done_edge_RBO] [get_bd_pins axi_dma_SG_sort/axi_resetn] [get_bd_pins data2axistream_v1_0_3/m00_axis_aresetn] [get_bd_pins data2axistream_v1_0_4/m00_axis_aresetn] [get_bd_pins data2ram_dcs/m00_axi_aresetn] [get_bd_pins data2ram_gs/m00_axi_aresetn]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon_1/ARESETN] [get_bd_pins axi_mem_intercon_2/ARESETN] [get_bd_pins ps7_1_axi_periph/ARESETN] [get_bd_pins ps7_1_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  ...
  connect_bd_net -net vsync_in_1 [get_bd_ports vsync_in] [get_bd_pins TOF_cos_sl_0/vsync_in_SI]
  ...
  connect_bd_net -net xsync_sat_in_1 [get_bd_ports xsync_sat_in] [get_bd_pins TOF_cos_sl_0/xsync_sat_in_SI]
