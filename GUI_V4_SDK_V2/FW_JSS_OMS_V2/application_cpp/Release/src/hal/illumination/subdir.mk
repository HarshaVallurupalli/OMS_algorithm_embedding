...
C_SRCS += \
../src/hal/illumination/illumination.c 

OBJS += \
./src/hal/illumination/illumination.o 

C_DEPS += \
./src/hal/illumination/illumination.d 


# Each subdirectory must supply rules for building sources it contributes
src/hal/illumination/%.o: ../src/hal/illumination/%.c
	@echo 'Building file: $<'
