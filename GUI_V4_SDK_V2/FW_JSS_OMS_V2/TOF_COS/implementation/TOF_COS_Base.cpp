...
//Algorithm Edit
void TOF_COS_Base::setMovementDetectionAlgorithmSettings(const MovementDetectionAlgorithmSettings algorithmSettings)
{
  context.calculation->setMovementDetectionAlgorithmSettings(algorithmSettings);
}

void TOF_COS_Base::setSkeletonDetectionAlgorithmEnabled(const bool enabled)
{
  context.calculation->setSkeletonDetectionAlgorithmEnabled(enabled);
}
