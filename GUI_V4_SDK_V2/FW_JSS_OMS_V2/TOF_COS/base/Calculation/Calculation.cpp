...
//Algorithm Edit
void Calculation::setMovementDetectionAlgorithmSettings(const MovementDetectionAlgorithmSettings algorithmSettings)
{
	algorithm.setMovementDetectionAlgorithmSettings(algorithmSettings);
}

MovementDetectionAlgorithmSettings Calculation::getMovementDetectionAlgorithmSettings() const
{
  return algorithm.getMovementDetectionAlgorithmSettings();
}

bool Calculation::getifMovementDetectionAlgorithmEnabled()
{
	return  algorithm.getMovementDetectionAlgorithmEnabled();

	}

void Calculation::setSkeletonDetectionAlgorithmEnabled(const bool enabled)
{
	algorithm.setSkeletonDetectionAlgorithmEnabled(enabled);
}

bool Calculation::getifSkeletonDetectionAlgorithmEnabled() const
{
	return algorithm.getSkeletonDetectionAlgorithmEnabled();
