...
public:
    ...
    void setupUi(QWidget *WidgetSettingsBase)
    {
        ...
        labelTitle = new QLabel(WidgetSettingsBase);
...
""));
    ...
    void retranslateUi(QWidget *WidgetSettingsBase)
    {
        ...
        labelTitle->setText(QCoreApplication::translate("WidgetSettingsBase", "<html><head/><body><p>BASE SETTINGS</p></body></html>", nullptr));
    } // retranslateUi
