...
#include <memory>
#include "../../include/qwtplot3d/qwt3d_surfaceplot.h"
...
void Qwt3D::SurfacePlot::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SurfacePlot *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (SurfacePlot::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SurfacePlot::resolutionChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Qwt3D::SurfacePlot::staticMetaObject = { {
    &Plot3D::staticMetaObject,
    qt_meta_stringdata_Qwt3D__SurfacePlot.data,
    qt_meta_data_Qwt3D__SurfacePlot,
    qt_static_metacall,
    nullptr,
    nullptr
} };
