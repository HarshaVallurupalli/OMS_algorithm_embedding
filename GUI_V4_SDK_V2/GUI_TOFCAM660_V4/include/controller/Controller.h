...
public:
    ...
    void requestMovementDetection(const bool isStream);
    void requestCam1_Data(const bool isStream);//edit
    void requestCam2_Data(const bool isStream);
    void requestCam3_Data(const bool isStream);
    void requestCam4_Data(const bool isStream);
    void request_Data_TCP_IP(const bool isStream);//edit
    void request_Data_UDP_IP(const bool isStream);
    void stopStream();
