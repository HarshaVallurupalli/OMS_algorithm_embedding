...
class Interface: public QObject
{
  ...
  public:
    ...
    void requestMovementDetection(const bool doStream, const QByteArray &userData = nullptr);
    void requestCam1_Data(const bool doStream, const QByteArray &userData = nullptr);//EDIT
    void requestCam2_Data(const bool doStream, const QByteArray &userData = nullptr);
    void requestCam3_Data(const bool doStream, const QByteArray &userData = nullptr);
    void requestCam4_Data(const bool doStream, const QByteArray &userData = nullptr);
    void request_Data_TCP_IP(const bool doStream, const QByteArray &userData = nullptr);//EDIT
    void request_Data_UDP_IP(const bool doStream, const QByteArray &userData = nullptr);
    ...
    void setAlgorithm(const bool SkeletonDetectionAlgorithm, const uint16_t MDAWindowSize, const uint16_t MDAImageType, const QByteArray &userData = nullptr);
