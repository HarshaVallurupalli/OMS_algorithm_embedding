...
class WidgetData : public QWidget
{
  ...
  public:
    ...
    void showDistance(ApplicationContext &context,const char *pData, DataHeader &dataHeader);
    ...
    void showData(ApplicationContext &context,const char *pData, DataHeader &dataHeader);
...
private:
    ...
    void updateImage(ApplicationContext &context,QLabel &label, const QImage &image);
