...
//void Settings::setCameraSelection(const int cameraSelection)//edit
//{
//  this->cameraSelection = cameraSelection;
//  emit cameraSelectionChanged(cameraSelection);
 // emit settingsChanged();
//}

int Settings::getCameraSelection() const
{
...
void Settings::setCameraNumber(uint camnum)//edit
{
    cameranumber = camnum;
}
uint Settings::getCameraNumber()
{
    return cameranumber;
}
void Settings::setStreamConnectionType(uint conntyp)
{
    connectiontype = conntyp;
}
uint Settings::getStreamConnectionType()//edit
{
...
void Settings::restore()
{
    ...
    cloud.setCameraMatrixElement(0, setupSettings->value("cameraMatrix0", 1.0).toDouble());
    cloud.setCameraMatrixElement(1, setupSettings->value("cameraMatrix1", 0).toDouble());
    cloud.setCameraMatrixElement(2, setupSettings->value("cameraMatrix2", 0).toDouble());
    cloud.setCameraMatrixElement(3, setupSettings->value("cameraMatrix3", 0).toDouble());
    cloud.setCameraMatrixElement(4, setupSettings->value("cameraMatrix4", 1.0).toDouble());
    cloud.setCameraMatrixElement(5, setupSettings->value("cameraMatrix5", 0).toDouble());
    cloud.setCameraMatrixElement(6, setupSettings->value("cameraMatrix6", 0).toDouble());
    cloud.setCameraMatrixElement(7, setupSettings->value("cameraMatrix7", 0).toDouble());
    cloud.setCameraMatrixElement(8, setupSettings->value("cameraMatrix8", 1.0).toDouble());

    cloud.setDistortionCoeffElement(0, setupSettings->value("distCoeffs0", 0).toDouble());
    cloud.setDistortionCoeffElement(1, setupSettings->value("distCoeffs1", 0).toDouble());
    cloud.setDistortionCoeffElement(2, setupSettings->value("distCoeffs2", 0).toDouble());
    cloud.setDistortionCoeffElement(3, setupSettings->value("distCoeffs3", 0).toDouble());
    cloud.setDistortionCoeffElement(4, setupSettings->value("distCoeffs4", 0).toDouble());
    cloud.setDistortionCoeffElement(5, setupSettings->value("distCoeffs5", 0).toDouble());
    cloud.setDistortionCoeffElement(6, setupSettings->value("distCoeffs6", 0).toDouble());
    cloud.setDistortionCoeffElement(7, setupSettings->value("distCoeffs7", 0).toDouble());
...
{            
    ...
    setupSettings->setValue("cameraMatrix0", QVariant::fromValue(cloud.getCameraMatrixElement(0)));
    setupSettings->setValue("cameraMatrix1", QVariant::fromValue(cloud.getCameraMatrixElement(1)));
    setupSettings->setValue("cameraMatrix2", QVariant::fromValue(cloud.getCameraMatrixElement(2)));
    setupSettings->setValue("cameraMatrix3", QVariant::fromValue(cloud.getCameraMatrixElement(3)));
    setupSettings->setValue("cameraMatrix4", QVariant::fromValue(cloud.getCameraMatrixElement(4)));
    setupSettings->setValue("cameraMatrix5", QVariant::fromValue(cloud.getCameraMatrixElement(5)));
    setupSettings->setValue("cameraMatrix6", QVariant::fromValue(cloud.getCameraMatrixElement(6)));
    setupSettings->setValue("cameraMatrix7", QVariant::fromValue(cloud.getCameraMatrixElement(7)));
    setupSettings->setValue("cameraMatrix8", QVariant::fromValue(cloud.getCameraMatrixElement(8)));

    setupSettings->setValue("distCoeffs0", QVariant::fromValue(cloud.getDistortionCoeffElement(0)));
    setupSettings->setValue("distCoeffs1", QVariant::fromValue(cloud.getDistortionCoeffElement(1)));
    setupSettings->setValue("distCoeffs2", QVariant::fromValue(cloud.getDistortionCoeffElement(2)));
    setupSettings->setValue("distCoeffs3", QVariant::fromValue(cloud.getDistortionCoeffElement(3)));
    setupSettings->setValue("distCoeffs4", QVariant::fromValue(cloud.getDistortionCoeffElement(4)));
    setupSettings->setValue("distCoeffs5", QVariant::fromValue(cloud.getDistortionCoeffElement(5)));
    setupSettings->setValue("distCoeffs6", QVariant::fromValue(cloud.getDistortionCoeffElement(6)));
    setupSettings->setValue("distCoeffs7", QVariant::fromValue(cloud.getDistortionCoeffElement(7)));
