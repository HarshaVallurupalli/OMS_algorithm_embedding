...
*/
void Plot3D::setRotation( double xVal, double yVal, double zVal, bool update )
{
    if(fabs(xRot_ - xVal) < std::numeric_limits<double>::epsilon() && fabs(yRot_ - yVal) < std::numeric_limits<double>::epsilon() && fabs(zRot_ - zVal) < std::numeric_limits<double>::epsilon())
    {
        return;
    }
...
*/
void Plot3D::setShift( double xVal, double yVal, double zVal, bool update)
{
...
/**
  ...
  which encloses the unscaled and unzoomed data
    ...
    \see setShift()
*/
void Plot3D::setViewportShift( double xVal, double yVal, bool update )
{
...
*/
void Plot3D::setScale( double xVal, double yVal, double zVal, bool update )
{
...
*/
void Plot3D::setZoom( double val, bool update )
{
    if(fabs(zoom_ - val) < std::numeric_limits<double>::epsilon() )
        return;
